...
export default function Store() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // productData state seems redundant if selectedProduct is used, consider removing setProductData
      // If you still need productData for some reason, ensure it's cleared or updated correctly.
      // For now, assuming selectedProduct is the source of truth for product info in the modal.
    } catch (error) {
