          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Learn about our mission, vision, and the team behind our
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground md:text-xl/relaxed">
                Our mission is to foster innovation and entrepreneurship by
                providing resources, mentorship, and a supportive community for
                individuals and teams with transformative ideas. We believe that
                entrepreneurship is a powerful vehicle for creating positive
                social, economic, and environmental impact.
              </p>
              <p className="text-muted-foreground md:text-xl/relaxed">
                We are committed to making entrepreneurship accessible to all,
                regardless of background or experience, and to supporting
                ventures that address meaningful challenges in our world.
              </p>
            </div>
            <div className="space-y-4">
              <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">
              ...
              <p className="text-muted-foreground md:text-xl/relaxed">
                We envision a future where our innovation center is the heart of
                a thriving entrepreneurial ecosystem that generates sustainable
                solutions to local and global challenges. We aim to be a
                catalyst for economic growth, job creation, and positive social
                change in our community and beyond.
              </p>
              <p className="text-muted-foreground md:text-xl/relaxed">
                By 2030, we aspire to have supported over 500 startups, created
                5,000 jobs, and established our region as a recognized hub for
                innovation in technology, sustainability, and social enterprise.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-10">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                The dedicated professionals who make our innovation center
                possible.
              </p>
            </div>
          </div>
                ...
                {[
                  {
                    ...
                    image:
                      "/placeholder.svg?height=300&width=300&text=Dr.+Jane",
                  ...
                  },
                  {
                    ...
                    image:
                      "/placeholder.svg?height=300&width=300&text=Michael+J",
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {[
                  ...
                  },
                  {
                    ...
                    image:
                      "/placeholder.svg?height=200&width=200&text=Carlos+M",
                  ...
                  },
                  {
                    ...
                    image:
                      "/placeholder.svg?height=200&width=200&text=Robert+K",
                ...
                {[
                  {
                    ...
                    image:
                      "/placeholder.svg?height=200&width=200&text=Dr.+Thomas",
                  ...
                  },
                  {
                    ...
                    image:
                      "/placeholder.svg?height=200&width=200&text=Jennifer+M",
                  ...
                  },
                  {
                    ...
                    image:
                      "/placeholder.svg?height=200&width=200&text=Richard+W",
                  ...
                  },
                  {
                    ...
                    image:
                      "/placeholder.svg?height=200&width=200&text=Mayor+Brown",
                  ...
                  },
                  {
                    ...
                    image:
                      "/placeholder.svg?height=200&width=200&text=Samuel+J",
                  ...
                  },
                  {
                    ...
                    image:
                      "/placeholder.svg?height=200&width=200&text=Dr.+Priya",
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Schedule a tour to see our facilities and learn more about how
